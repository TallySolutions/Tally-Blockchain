...
#Usage: CreateOrdererNode.sh <ORDERER-HOST>
...
. ./SetGlobalVariables.sh

#Variables

DOAMIN=tally.tallysolutions.com
TLSCA=tbchlfdevca01.tally.tallysolutions.com:7054
CA_NAME=ca-orderer
ORDERERCA_CREDS=ordadmin:ordadminpw
ORDERERCA_URL=tbchlfdevca01.tally.tallysolutions.com:7056
ORDERERCA_CERTNAME=tbchlfdevca01_tally_tallysolutions_com_7056
ORDERER_HOST=$1


mkdir -p ${TALLY_HOME}/organizations/ordererOrganizations/${DOMAIN}
